                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="pro/signin.php" class="page-scroll">
                            ...
                            <li><a href="pro/hostsignin.php" class="page-scroll">
                                <h3>Host Portal</h3>
                            </a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements="Contactless Visitor Check-In, Contactless Visitor Check-In"></span></h1>

                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Schedulling System"></span>
                            </h1>

                            <p class="main-heading-text">WELCOME TO,<br />Contactless Visitor Check-in</p>

                            <div class="btn-bar">

                                <a href="pro/signin.php" class="btn btn-custom theme_background_color">Schedule Now</a>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">Contactless Visitor Check-in Contact List</h1>

                            <p class="main-heading-text">The Contactless Visitor Check-in Corporation is 11 years old 
                                <br />The Contactless Visitor Check-in
                            </p>
                ...
                <div class="row about-box">
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <div class="margin-bottom">
                            ...
                            <h4>Schedule visitation from the comfort of your home</h4>

                            <p class="black">Schedule visitation from anywhere using the robustContactless Visitor Check-in platform
                                exclusively built to provide the Visitor with pleasant check-in experience. </p>
                    ...
                    <div class="col-sm-4 about-line text-center">
                        ...
                        <div class="margin-bottom">
                            ...
                            <h4>Contactless Visitor Check-in related information at your fingertips</h4>

                            <p class="black">Checkout available seats, price information on real time
