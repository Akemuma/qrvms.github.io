...
<head>
    ...
    <title><?php echo SITE_NAME, ' - Attendee\'s Account' ?> </title>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="individual.php?page=reg" class="nav-link <?php echo (@$_GET['page'] == 'reg') ? 'active' : '';?>">
                                ...
                                <p>New Paid Visitation</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="individual.php?page=free" class="nav-link <?php echo (@$_GET['page'] == 'free') ? 'active' : '';?>">
                                <i class="fa fa-plus nav-icon"></i>
                                <p>Free/Apartment Visitation</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="individual.php?page=paid" class="nav-link <?php echo (@$_GET['page'] == 'paid') ? 'active' : '';?>">
                                <i class="fa fa-book nav-icon"></i>
                                <p>View Visitations</p>
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> Visitors Dashboard</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
