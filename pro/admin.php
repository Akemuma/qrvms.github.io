        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=hosts" class="nav-link 
                            <?php
                            echo (@$_GET['page'] == 'hosts') ? 'active' : '';
                            ?>
                            ">
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=Location" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=free" class="nav-link      <?php
