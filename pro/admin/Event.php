                ...
                <div class="col-sm-12">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">
                                All Events/Occasions</h3>
                            <div class='float-right'>
                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                    data-target="#add">
                                    Add New Event/Occasion 
                                </button></div>
                        </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        <input type="hidden" class="form-control" name="id"
                                                            value="<?php echo $id ?>" required id="">
                                                        <p>Event/Occasion Name : <input type="text" class="form-control"
                                                                name="name" value="<?php echo $fetch['name'] ?>"
                                                                required minlength="3" id=""></p>
                                                        <p>VIP Capacity : <input type="number" min='0'
                                                                class="form-control"
                                                                value="<?php echo $fetch['first_seat'] ?>"
                                                                name="first_seat" required id="">
                                                        </p>
                                                        <p>Regular Capacity : <input type="number" min='0'
                                                                class="form-control"
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title">Add New Event/Occasion ;
                </h4>
...
if (isset($_POST['submit'])) {
    ...
    if (!isset($name, $first_seat, $second_seat)) {
        ...
        if ($check) {
            ...
            $ins = $conn->prepare("INSERT INTO Event (name, first_seat, second_seat) VALUES (?,?,?)");
...
if (isset($_POST['edit'])) {
    ...
    if (!isset($name, $first_seat, $second_seat)) {
        ...
        if ($check == 2) {
            ...
            $ins = $conn->prepare("UPDATE Event SET name = ?, first_seat = ?, second_seat = ? WHERE id = ?");
