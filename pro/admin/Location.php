                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" style="align-items: stretch;"
                                ...
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Area/Apartment Name</th>
                                        <th>Location/House Num</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $row = $conn->query("SELECT * FROM Location");
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post">
                                                        <input type="hidden" class="form-control" name="id"
                                                            value="<?php echo $id ?>" required id="">
                                                        <p>Apartment/Area : <input type="text" class="form-control"
                                                                value="<?php echo $fetch['start'] ?>" name="start"
                                                                required id="">
                                                        </p>
                                                        <p> Location/House No : <input type="text" class="form-control"
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Location/House No </th>
                            <td><input type="text" class="form-control" name="stop" id="">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
...
if (isset($_POST['submit'])) {
    ...
    if (!isset($stop, $start)) {
        ...
        $ins = $conn->prepare("INSERT INTO Location (start,stop) VALUES (?,?)");
...
if (isset($_POST['edit'])) {
    ...
    if (!isset($start, $stop)) {
        ...
        $conn = connect();
        $ins = $conn->prepare("UPDATE Location SET start = ?, stop = ? WHERE id = ?");
...
if (isset($_POST['del_Event'])) {
    $con = connect();
    $conn = $con->query("DELETE FROM Location WHERE id = '" . $_POST['del_Event'] . "'");
    if ($con->affected_rows < 1) {
        alert("Location Could Not Be Deleted. This Location Has Been Tied To Another Data!");
        load($_SERVER['PHP_SELF'] . "$me");
    } else {
