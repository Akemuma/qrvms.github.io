...
$file_access = true;
include '../conn.php';
include 'host_session.php';
include '../constants.php';
if (@$_GET['page'] == 'print' && isset($_GET['code'])) {
    printClearance($_GET['code']);
    // echo "<script>window.location='host.php'</script>";
}
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            <!-- Brand Logo -->
            <a href="host.php" class="brand-link">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="host.php" class="nav-link <?php if (!isset($_GET['page'])) echo 'active'; ?>">
                        ...
                        <li class="nav-item">
                            <a href="host.php?page=dynamic" class="nav-link 
                            <?php
                        ...
                        <li class="nav-item">
                            <a href="host.php?page=Location" class="nav-link      <?php
                                                                                echo (@$_GET['page'] == 'Location') ? 'active' : '';
                                                                                ?>">
                        ...
                        <li class="nav-item">
                            <a href="host.php?page=Event" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="host.php?page=free" class="nav-link      <?php
                                                                                echo (@$_GET['page'] == 'free') ? 'active' : '';
                                                                                ?>">
                                <i class="nav-icon fas fa-Event"></i>
                                <p>
                                    Free & Apartment
                        ...
                        <li class="nav-item">
                            <a href="host.php?page=search" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="host.php?page=logout" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> Host Dashboard</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            elseif ($_GET['page'] == 'dynamic')
                include 'host/dynamic_VisitSchedule.php';
            
            elseif ($_GET['page'] == 'Event')
                include 'host/Event.php';
            elseif ($_GET['page'] == 'free')
                include 'host/free.php';
            elseif ($_GET['page'] == 'Location')
                include 'host/Location.php';
