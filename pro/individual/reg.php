                ...
                <div class="card-body">
                    ...
                    <table id="example1" style="align-items: stretch;"
                        ...
                        <tbody>
                            ...
                            Sorry, There are no Visitation-Reason at the moment! Please visit after some time.
                          </div>";
                            $sn = 0;
                            while ($fetch = $row->fetch_assoc()) {
                                ...
                                <td><?php echo $fullname =  getLocationPath($fetch['Location_id']);
                                        ?></td>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Schedule For <?php echo $fullname;
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="<?php echo $_SERVER['PHP_SELF'] . "?loc=$id" ?>"
                                                ...
                                                <p>Number of Tickets (If you are the only one, leave as it is) :
                                                    <input type="number" min="1" max="5" value="1" name="number" class="form-control" id="">

                                                </p>
                                                <p>
                                                    Class : <select name="class" required class="form-control" id="">
                                                        <option value="">-- Select Class --</option>
                                                        <option value="first">VIP (Kshs
                                                            <?php echo ($fetch['first_fee']); ?>)</option>
                                                        <option value="second">Regular (Kshs
