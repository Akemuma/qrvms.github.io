...
<?php
        ...
        $check_email = $conn->prepare("SELECT * FROM Attendee WHERE email = ? OR phone = ?");
...
<?php
            ...
            $stmt = $conn->prepare("INSERT INTO Attendee (name, email, password, phone, address, loc) VALUES (?,?,?,?,?,?)");
...
<div class="signup-page">
    <div class="form">
        ...
        <p class="alert alert-info">
            <marquee behavior="" scrollamount="2" direction="">You need to create an account to Schedule/view Visitations!
            </marquee>
        </p>
