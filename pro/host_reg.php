...
<?php
        ...
        $check_email = $conn->prepare("SELECT * FROM host WHERE email = ? OR phone = ?");
...
<?php
            ...
            $stmt = $conn->prepare("INSERT INTO host (name, email, password, phone, address, loc) VALUES (?,?,?,?,?,?)");
            $stmt->bind_param("ssssss", $name, $email, $password, $phone, $address, $loc);
            if ($stmt->execute()) {
            ?>
<script>
alert("Congratulations.\nYou are now registered.");
window.location = 'hostsignin.php';
</script>
<?php
            } else {
            ?>
...
<div class="signup-page">
    <div class="form">
        ...
        <p class="alert alert-info">
            <marquee behavior="" scrollamount="2" direction="">You need to create an account
            </marquee>
        </p>
        <form class="login-form" method="post" role="form" enctype="multipart/form-data" id="signup-form"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" minlength="10"  required name="phone">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
